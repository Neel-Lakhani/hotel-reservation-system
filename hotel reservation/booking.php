...
<body class="bg-light">
  ...
  <div class="container my-4">
    <div class="row featurette d-flex justify-content-center align-items-center">
      ...
      <div class="col-md-7 ">
        ...
        <p class="lead my-3">Premium Suits offers luxuary stay to Guests. It is fully fernished and decorated suit. Guests can enjoy all of the facalities of our hotel.</p>
  ...
  <div class="container my-4">
    <div class="row featurette d-flex justify-content-center align-items-center">
      <div class="col-md-5 pop">
        <img class="bd-placeholder-img rounded-5 bd-placeholder-img-lg featurette-image img-fluid mx-auto mb-4"
          src="./img/room-4.jpg" alt="">
      </div>
      <div class="col-md-7 ">
        <h2 class="featurette-heading fw-normal lh-1"> Superior City View Room </h2>
        <p class="lead my-3">The Superior City View Room at our hotel offers breathtaking views of the city skyline. Guests can enjoy a comfortable and stylish room with modern amenities.</p>
  ...
  <div class="container my-4">
    <div class="row featurette d-flex justify-content-center align-items-center">
      <div class="col-md-5 pop">
        <img class="bd-placeholder-img rounded-5 bd-placeholder-img-lg featurette-image img-fluid mx-auto mb-4"
          src="./img/room-5.jpg" alt="">
      </div>
      <div class="col-md-7 ">
        <h2 class="featurette-heading fw-normal lh-1">Normal Rooms </h2>
        <p class="lead my-3">This rooms offers basic room services and food services. Guests can enjoy city view and hotel compound view from the window. </p>
  ...
  <div class="container my-4">
    <div class="row featurette d-flex justify-content-center align-items-center">
      <div class="col-md-5 pop">
        <img class="bd-placeholder-img rounded-5 bd-placeholder-img-lg featurette-image img-fluid mx-auto mb-4"
          src="./img/room-6.jpg" alt="">
      </div>
      <div class="col-md-7 ">
        <h2 class="featurette-heading fw-normal lh-1">Superior Suit </h2>
        <p class="lead my-3">Experience luxury and elegance at its finest in our Superior Rooms at the Palm Hotel. Guests can enjoy the spacious and luxurious room which is equipped with high-end amenities </p>
